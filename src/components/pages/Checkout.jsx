...
const Checkout = () => {
  ...
  return (
    <>
      <Header cls="Checkout Bg-products Header">
        ...
        <article className="Flex-column-center">
          ...
          <div className="Checkout-product-desc">
            ...
            <p className="Text">
              ...
              fácil de montar está listo para establecer algunas líneas
              clásicas. !Ábrase camino por el paseo maritimo de noche o de día
              con las ruedas Lumithane de 67 mm, con núcleos LED que alimentan
              el uretano Glow in the Dark¡ Si eso no fue suficiente para
              iluminar tu camino, el mazo negro completamente sumergido presenta
              un gráfico de Glow in the Dark que brilla sin importar la hora del
              dia.
            </p>
            <h2>Dimensiones</h2>
            <h3>Longitud: 40.0"</h3>
            ...
            <p className="Text">
              7 capas de arce Full Dip Black Deck LED Powered GID Lumithane
              Wheels Brillan en la oscuridad Lámina por Daniel Sheridan
            </p>
          </div>
          <Button
            cls='Flex-column-center Checkout-button-container'
